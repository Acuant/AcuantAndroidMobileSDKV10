 ...
 * </ol>
 */
public class DocumentGraphicOverlay<T extends DocumentGraphicOverlay.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link DocumentGraphicOverlay#add(Graphic)}.
     */
    public static abstract class Graphic {
        private DocumentGraphicOverlay mOverlay;

        public Graphic(DocumentGraphicOverlay overlay) {
            mOverlay = overlay;
        }
    ...
    public DocumentGraphicOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
